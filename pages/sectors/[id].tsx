  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-center bg-white">
        <div className="mx-5 mb-10 grid max-w-[1264px] grid-cols-4 items-center justify-center gap-y-5 gap-x-10 md:mx-10" >
          ...
          <motion.div className="col-span-4 text-black" dangerouslySetInnerHTML={{ __html: sector?.briefDescription }} 
            initial={{ opacity: 0, y: 15 }} 
            animate={{ opacity: 1 ,y :0 }} 
          ...
          <motion.div className="col-span-4 text-black md:col-span-3"
            initial={{ opacity: 0, x:-15 }} 
            animate={{ opacity: 1 , x:0 }} 
